            ...
            <li>
              <button type="button" class="btn btn-link p-0"
               data-toggle="modal" data-target="#tryonModalCenter">
                <i class="fas fa-tshirt"></i> Попробовать
              </button>
            </li>
            <li>
      ...
      <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body pt-0 text-center">
            <h5 class="mb-4">Размер продукта</h5>
            <div class="row">
          ...
          <div class="modal-body pt-0 text-center">
            ...
            <div class="row">
              <div class="col-lg-6 col-12">
                ...
                <p>*Индивидуальные пропорции различаются, только для справки</p>
              </div>
              <div class="col-lg-6 col-12">
    ...
    getProduct() {
      ...
      vm.$http.get(url).then((response) => {
        if (response.data.success) {
          ...
          vm.$store.dispatch('alertMessageModules/updateMessage', { message: 'Не удалось найти этот пункт', status: 'danger' });
        }
