...
//     routes: [
//         {path: "/", component: Shop},
//         {path: "/about", component: () => import(/* webpackChunkName: "home" */ "./views/Login.vue")},
//         {path: "/login", component: () => import(/* webpackChunkName: "home" *../views/LoginVuew.vuevue")},
//         {path: "/:pid/login", component: () => import(/* webpackChunkName: "home" *../views/LoginVuew.vuevue")},
